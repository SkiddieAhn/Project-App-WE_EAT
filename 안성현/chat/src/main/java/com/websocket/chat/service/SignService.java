...
interface SignServiceIF {
    public int signUp(String user_id,String pw,int user_state,String name,String user_sid,String user_dept) throws NoSuchAlgorithmException;
...
public class SignService implements SignServiceIF{
    ...
    public int signUp(String user_id,String pw,int user_state,String name,String user_sid,String user_dept) throws NoSuchAlgorithmException {
       ...
       try{
            signMapper.signUp(user_id,pw2,user_state,name,user_dept,user_sid);
            return 1;
       }
       catch(Exception e){
           return 0;
